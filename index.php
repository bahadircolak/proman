...
<body>
    ...
    <div class="modal fade" id="saEditUserModal" tabindex="-1" aria-labelledby="saEditUserModalLabel" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><h5 class="modal-title" id="saEditUserModalLabel">Edit User: <span id="saEditUserName"></span></h5><button type="button" class="close" data-dismiss="modal">&times;</button></div><div class="modal-body"><form id="saEditUserForm"><input type="hidden" id="saEditUserId"><div class="form-group"><label for="saEditUserRole">Role</label><select id="saEditUserRole" class="form-control"><option value="user">User</option><option value="company_admin">Company Admin</option><option value="super_admin">Super Admin</option></select></div><div class="form-group"><label for="saEditUserCompanySelect">Assign to Company</label><select id="saEditUserCompanySelect" class="form-control"></select><small>Current: <span id="saEditUserCurrentCompany"></span></small></div></form><div id="saEditUserMessage" class="mt-2"></div></div><div class="modal-footer"><button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button><button type="button" class="btn btn-primary" id="saSaveChangesToUserButton">Save Changes</button></div></div></div></div>

    <!-- Super Admin Edit Company Modal -->
    <div class="modal fade" id="saEditCompanyModal" tabindex="-1" aria-labelledby="saEditCompanyModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="saEditCompanyModalLabel">Edit Company</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">&times;</button>
                </div>
                <div class="modal-body">
                    <form id="saEditCompanyForm">
                        <input type="hidden" id="saEditCompanyIdToUpdate">
                        <!-- CSRF token will be added by JS if needed, or use a global one -->
                        <div class="form-group">
                            <label for="saEditCompanyName">Company Name</label>
                            <input type="text" class="form-control" id="saEditCompanyName" required>
                        </div>
                    </form>
                    <div id="saEditCompanyMessage" class="mt-2"></div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-primary" id="saSaveChangesToCompanyButton">Save Changes</button>
                </div>
            </div>
        </div>
    </div>

    <!-- Super Admin Delete Company Confirmation Modal -->
    <div class="modal fade" id="saDeleteCompanyConfirmModal" tabindex="-1" aria-labelledby="saDeleteCompanyConfirmModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="saDeleteCompanyConfirmModalLabel">Confirm Company Deletion</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">&times;</button>
                </div>
                <div class="modal-body">
                    <input type="hidden" id="saCompanyIdToDelete">
                    <p>Are you sure you want to delete company: <strong id="saDeleteCompanyNameConfirm"></strong> (ID: <span id="saDeleteCompanyIdConfirm"></span>)?</p>
                    <p class="text-danger">This action cannot be undone. Deletion is only possible if the company has no associated users or boards.</p>
                    <div id="saDeleteCompanyConfirmMessage" class="mt-2"></div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-danger" id="saConfirmDeleteCompanyButton">Confirm Delete</button>
                </div>
            </div>
        </div>
    </div>
